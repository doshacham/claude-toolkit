0a. Study `specs/*` with up to 10-15 parallel subagents to learn the application specifications.
...
99999999999999. If you find inconsistencies in the specs/* then use an subagent with requested to update the specs.
