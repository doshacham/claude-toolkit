...
description: This skill rewrites CLAUDE.md files using <important if> conditional blocks to improve instruction adherence. Use when the user asks to "improve my CLAUDE.md", "rewrite my CLAUDE.md", "optimize Claude instructions", "Claude keeps ignoring my rules", "make CLAUDE.md more effective", or wants to restructure a CLAUDE.md for better conditional behavior.
---
