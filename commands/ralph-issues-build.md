...
Work through the issues in order of priority.
...
Before committing, run the feedback loops. Determine the correct commands to run the tests and type checker for this project by inspecting package.json, Makefile, or equivalent configuration.
